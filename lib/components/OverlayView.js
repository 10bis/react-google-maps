...
var OverlayView = (exports.OverlayView = (function(_React$PureComponent) {
  ...
  function OverlayView(props, context) {
    ...
    overlayView.onAdd = _lodash2.default.bind(_this.onAdd, _this)
    overlayView.draw = _lodash2.default.bind(_this.draw, _this)
    overlayView.onRemove = _lodash2.default.bind(_this.onRemove, _this)
    _this.onPositionElement = _lodash2.default.bind(
  ...
  ;(0, _createClass3.default)(OverlayView, [
    ...
    },
    {
      ...
      value: function onPositionElement() {
        ...
        _lodash2.default.assign(this.containerElement.style, layoutStyles)
      },
    },
    {
      key: "onRemove",
    ...
    },
    {
      ...
      value: function componentDidUpdate(prevProps) {
        ...
        _lodash2.default.delay(this.state[_constants.OVERLAY_VIEW].draw)
      },
    },
    {
